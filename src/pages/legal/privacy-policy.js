...
const Privacy = () => {
  return (
    <>
    <Head>
    <title>Privacy Policy - Hipla</title>
    <link rel="icon" href="/favicon.jpg" />
    <meta
      name="description"
      content="At Hipla,  We respect your privacy, value the relationship we have with you. Our secure infrastructure protects your visitor, employee data and company information.If you have any questions or comments about our Privacy Policy, you can contact us at info@hipla.io"
    />
   <meta
    name="keywords"
    content="privacy policy hipla, visitor management system, hipla"
    />
    <link rel="canonical" href="https://hipla.io/legal/privacy-policy" />
  </Head>
    ...
    <Holder>
      <Container>
        <TextCenter>
          ...
          <Date>Last updated on March 12, 2020</Date>
        </TextCenter>
        <p>Hipla (“us”, “we”, or “our”) operates the hipla.io website (the “Service”).</p>
        ...
        <p>
          ...
          this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from hipla.io
        </p>
        <h5 className="font-weight-bold">Information Collection And Use</h5>
        <p>
        ...
        <br />
        <h6 className="font-weight-bold">Tracking &amp; Cookies Data</h6>
        <p>
        ...
        <h5 className="font-weight-bold">Use of Data</h5>
        <p>Hipla uses the collected data for various purposes:</p>
        <ul>
        ...
        <h5 className="font-weight-bold">Transfer Of Data</h5>
        <p>
        ...
        <p>
          Hipla will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
        ...
        <p>&nbsp;</p>
        <h5 className="font-weight-bold">Disclosure Of Data</h5>
        <p>
          <strong>Legal Requirements:</strong>
        </p>
        <p>Hipla may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
        ...
        <h5 className="font-weight-bold">Security Of Data</h5>
        <p>
